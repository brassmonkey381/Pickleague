...
// The engine ships with @just-messin-around/expo-foundation, same pattern as
// Doggle's tools/toolbox — this repo only holds config + launcher.
...
const candidates = [
  path.join(repoRoot, 'mobile/node_modules/@just-messin-around/expo-foundation/toolbox/server.mjs'),
];
