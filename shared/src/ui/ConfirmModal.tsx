...
/**
 * Reusable "Are you sure?" Modal with a Cancel/Action button row, replacing
 * hand-rolled confirm dialogs and multi-button Alert.alert calls (which silently
 * OK-collapse on web).
 *
 * Variants:
 *   - variant='primary'  → primary button (default)
